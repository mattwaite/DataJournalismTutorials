---
title: "Data Journalism Lesson 3: Replication"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
description: >
  Learn how to document your process.
---
...
In this lesson, you'll learn about the critical importance of replication and transparency in data journalism. You'll understand why being able to reproduce your analysis is essential for credibility and accuracy in reporting. By the end of this tutorial, you'll grasp the concept of keeping detailed logs of your data analysis process, know why traditional tools like Excel may fall short in this regard, and be introduced to more advanced tools like analysis notebooks that can help document your work step-by-step. You'll also learn the basics of working with R Notebooks, which will be your primary tool for the rest of this course.
...
The word you're seeing more and more of? Reproducible. And it started in earnest in the summer of 2017 when data journalism crossed a major threshold in American journalism: It now has it's own section in the Associated Press Stylebook.
...
Peter Aldous, a former data journalist at Buzzfeed published a story about how the online news site used machine learning to find airplanes being used to spy on people in American cities. Published with the story is the code Aldous used to build his case.
...
* To add text, simply type. 
* To add code you can click on the *Insert* button on the toolbar or by pressing *Cmd+Option+I* on Mac or *Ctl+Alt+I* on Windows.
...
Throughout this lesson, you've explored the growing emphasis on replication in data journalism, as highlighted by the AP Stylebook's guidelines. You've learned about the challenges of reproducing analyses and the importance of documenting your process thoroughly. You've been introduced to R Notebooks as a powerful tool for combining code, explanation, and results in a single, shareable document. Remember, transparency in your work isn't just about avoiding errors—it's about building trust with your audience and contributing to a more accountable form of journalism. As you move forward, keep in mind that every step of your data analysis should be documented and explainable, allowing others to follow your path from raw data to published conclusions.

## Terms to Know

- Replication: The process of reproducing a data analysis to verify its accuracy and credibility.
- Data Journalism: A form of journalism that uses data analysis and visualization to uncover and tell stories.
- AP Stylebook: A writing style guide for journalists that now includes standards for data journalism practices.
- Methodology Description: A detailed explanation of the steps taken in a data analysis, allowing others to reproduce the work.
- R Notebook: An interactive document that combines explanatory text, code, and output in a single file.
- Markdown: A lightweight markup language used for formatting text in R Notebooks and other documents.
- Code Repository: A storage location for code and related files, often used for sharing and collaborating on data journalism projects.
- Data Dictionary: A document that provides definitions and explanations for the variables in a dataset.
- Nerd Box: A sidebar in a news story that explains the technical details of how a data analysis was conducted.
- Reproducible Workflow: A series of documented steps in data analysis that allows others to repeat the process and obtain the same results.
